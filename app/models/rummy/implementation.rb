module Rummy
  class Implementation < ::Implementation
    ...
    def lay_off_turn(meld_index:, cards:)
      return nil unless drawn? && (0...melds.length).include?(meld_index)

      meld = current_player.try_lay_off(melds[meld_index], cards)
      return nil unless meld

      turn_result = TurnResult.new(current_user_id: current_user_id, meld: meld, laid_off_cards: cards)
      feed.push(turn_result)
      turn_result
    end
